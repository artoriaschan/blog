...
![renderProps介绍](~@assets/data-flow/render-props-introduce.png)
...
![Render Props例子](~@assets/data-flow/render-props-example.png)
...
![React Hooks例子](~@assets/data-flow/react-hooks-example.png)
...
![树结构1](~@assets/data-flow/immutable-tree-strcuture1.png)

插入新节点,让原有的树结构保持不变:

![树结构2](~@assets/data-flow/immutable-tree-strcuture2.png)

但这样做是低效的,既费时又费空间.因而有了如下的优化空间:

![树结构3](~@assets/data-flow/immutable-tree-strcuture3.png)
...
![结构共享](~@assets/data-flow/immutable-share-structure.png)
...
![mobx结构](~@assets/data-flow/mobx-structure.png)

![vuex结构](~@assets/data-flow/vuex-structure.png)
